...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/scribe")
}
...
MIGRATION_MODULES = {"sites": "scribe.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "scribe.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "scribe.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "scribe.users.adapters.SocialAccountAdapter"
